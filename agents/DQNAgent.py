...
import torch as T
import numpy as np
from CybORG.Agents.SimpleAgents.DeepQNetwork import DeepQNetwork, DeepRNNNetwork
from CybORG.Agents.SimpleAgents.ReplayBuffer import ReplayBuffer
...
class RNNDQNAgent(DQNAgent):
    ...
    def get_action(self, observation, action_space):
        ...
        # print("WHAT THE OBS ACTUALLY IS:", observation)
        # print("OBS BUFFER SHAPE:", self.observation_buffer.shape)
        # print("LEN OF OBS:", len(observation))
        if (observation.shape) != self.observation_buffer.shape: # if (observation[0].shape)
